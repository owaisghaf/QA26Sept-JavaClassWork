...
public class FilmService {
	...
	// throws a FilmNotFoundException when a searched id is not found
	...
	public List<Film> readByPlatform(String platform) {
		return this.filmRepo.findFilmByplatform(platform);
